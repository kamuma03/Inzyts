...
_AGENT_REGISTRY: Dict[str, Tuple[str, str]] = {
    ...
    "forecasting_strategy":     ("src.agents.phase2", "ForecastingStrategyAgent"),
    "comparative_strategy":     ("src.agents.phase2", "ComparativeStrategyAgent"),
    "diagnostic_strategy":      ("src.agents.phase2", "DiagnosticStrategyAgent"),
    "segmentation_strategy":    ("src.agents.phase2", "SegmentationStrategyAgent"),
