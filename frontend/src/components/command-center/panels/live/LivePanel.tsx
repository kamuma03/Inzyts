    ...
    return (
        <article className="border-b border-[var(--rule)] last:border-b-0">
            <div className="flex items-stretch">
                ...
                {/* Body — code editor or markdown preview/editor */}
                <div className="flex-1 min-w-0 py-2 pr-2">
                    {isCode ? (
                        <>
                            ...
                            {/* Tweak input */}
                            {cell.tweak_open && (
                                <div className="mt-2 flex items-center gap-2 bg-[var(--surface-2)] border border-[var(--accent)] rounded-md px-2.5 py-1.5">
                        ...
                        <>
                            {cell.md_editing ? (
                                ...
                                >
                                    ...
                                    />
                                    <span className="inline-flex items-center gap-1 mt-1 text-[10px] uppercase tracking-wider text-[var(--text-dim)] opacity-0 group-hover:opacity-100">
                                        <Pencil size={10} />
                                        Click to edit
                                    </span>
                                </button>
                    ...
                    {/* Cell ops toolbar — same row for code & markdown. */}
                    <div className="flex items-center gap-1 mt-1.5 text-[var(--text-dim)]">
                        <button
                            type="button"
                            onClick={onMoveUp}
                            disabled={isFirst}
